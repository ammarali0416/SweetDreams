guidelines = """You are tasked with generating consistent stylistic guidelines for illustrations that will be used throughout a PDF book. Below is the information provided about the overall illustrative style and the main characters:

- Illustrative Style: {IllustrativeStyle}
...
- Chapter Illustration Guidelines: {ChapterGuidelines}
- Chapter Plot: {ChapterPlot}
